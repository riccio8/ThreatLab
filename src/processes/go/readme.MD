...
#### Usage
```bash
process-tool set-priority <pid> <priority>
```
...
#### Usage
```bash
process-tool read-memory <pid> <address> <size>
```
...
#### Usage
```bash
process-tool write-memory <pid> <address> <data>
```
